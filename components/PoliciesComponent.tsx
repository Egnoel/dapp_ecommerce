...
interface PolicieInterface {
  marginTop?: number;
}

const PoliciesComponent = ({ marginTop }: PolicieInterface) => {
  return (
    <div
      className={`flex flex-row items-center justify-center gap-24 w-full px-20 ${
        marginTop ? `mt-${marginTop}` : 'mt-28'
      }`}
    >
